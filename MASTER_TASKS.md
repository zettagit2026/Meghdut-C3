...
- 🔄 **BATCH DEPLOY IN FLIGHT** (box clear) — one validated deploy carries all three; backend/frontend rebuild; adsb/parrot detection bridges + sdr-mavlink dormant companion + updated jam code; end-state tx_halted=True + all TX bridges dormant. Then operator re-tests continuous+swept jam.
