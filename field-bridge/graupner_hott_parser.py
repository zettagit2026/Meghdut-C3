...
class HoTTSerialBridge:
    ...
    def run_forever(self) -> None:
        ...
        # HoTT traffic is on the wire -- print a cheap "still listening" line
        ...
        while True:
            ...
            if not chunk:
                ...
                if now_idle - last_idle_heartbeat >= IDLE_HEARTBEAT_INTERVAL_S:
                    ...
                    print(f"[graupner_hott_parser] [heartbeat] still listening on "
                          f"{self.serial_device} -- no HoTT traffic decoded in "
